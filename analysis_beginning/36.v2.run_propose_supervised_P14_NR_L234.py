...
num_preselect = 200
num_genes = [10, 20, 30, 40, 50, 100] # 500 failed the memory #, 500] #[128, 64, 32, 16, 12] #12, 16, 32, 64, 128]

ddir = '/bigstore/GeneralStorage/fangming/projects/visctx/data_dump/counts/'
f = os.path.join(ddir, "P14_nr_L234_Oct26.h5ad")

study = "merfish_P14_NR_L234_oct28"
...
candidates, model = selector.eliminate(target=num_preselect, mbsize=32, max_nepochs=100, tol=0.3)

for num in num_genes:
    # Select specific number of genes
    inds, model = selector.select(num_genes=num, mbsize=32, max_nepochs=100)
