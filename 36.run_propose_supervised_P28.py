...
num_preselect = 1000
num_genes = [20, 50, 100, 150, 200] # 500 failed the memory #, 500] #[128, 64, 32, 16, 12] #12, 16, 32, 64, 128]

ddir = '/bigstore/GeneralStorage/fangming/projects/visctx/data_dump/counts/'
f = os.path.join(ddir, "P28_nr_allcells_Oct24.h5ad")

study = "merfish_P28_oct24"
